  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-[#150D14]/90 backdrop-blur-md border-b border-[rgba(201,133,106,0.12)]"
          : "bg-transparent"
      }`}
    >
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        {/* Mobile hamburger */}
        <button
          className="md:hidden text-[#90788E] cursor-pointer"
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="md:hidden bg-[#150D14]/95 backdrop-blur-md border-b border-[rgba(201,133,106,0.12)]"
          >
